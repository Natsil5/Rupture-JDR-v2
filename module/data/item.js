...
export default class LiberItemData extends foundry.abstract.DataModel {
  static defineSchema() {
    return {
      ...
      description: new foundry.data.fields.StringField({ required: false, initial: "" }),
      items: new foundry.data.fields.ArrayField(new foundry.data.fields.ObjectField({}), { initial: [] }) // Stocke les objets
    };
  }
}
